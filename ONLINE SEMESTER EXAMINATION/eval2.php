...
exit();
      ...
      $sql = "SELECT * FROM oanswer WHERE exam_id = '$exam_id' AND user_id='$reg'";
    ...
    {
        $sql = "SELECT * FROM objective WHERE exam_id = '$exam_id' AND q_id='$row1[2]'";
    ...
    $sql = "SELECT * FROM sanswer WHERE exam_id = '$exam_id' AND user_id='$reg'";
      $result1 = mysqli_query($con,$sql);
      $a=1;
		...
		<div class="container"  >
			<div class="col-sm-12" >
              ...
              <div id="c" style="display:;">
                        ...
                        echo "<caption style='color:#D7DA0F '>$row[2] subjective</capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Q. Id</th><th>Answer.</th></tr>";
                            while($row1=$result1->fetch_array())
                           {
                         
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><td>$row1[2]</td><td>$row1[3]</td></tr>";
                           }
