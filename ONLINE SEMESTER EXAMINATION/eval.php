...
exit();
      ...
      $sql = "SELECT * FROM exam WHERE user_id = '$id'";
			...
			<div class="col-sm-12" >
              ...
              <div id="c" style="display:;">
                        ...
                        echo "<caption style='color:#D7DA0F '>$row[2] </capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Exam Id</th><th>Exam Type</th><th>Marks.</th><th>See participation</th></tr>";
                            while($row1=$result1->fetch_array())
                           {
                         
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><td>$row1[0]</td><td>$row1[3]</td><td>$row1[4]</td><td>
                            <form id='loginform' class='form-horizontal' role='form' action='eval1.php' method='post'>
