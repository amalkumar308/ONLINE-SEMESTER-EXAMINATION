...
<nav class="navbar-fixed-top navbar navbar-dark bg-primary " style="background-color: green;" role="navigation">
     ...
     <div class="collapse navbar-collapse active" id="myNavbar">
      <ul class="nav navbar-nav mr-auto" style="background-color: green; color:peachpuff;">
        <li class="nav-item active"><a class="nav-link" href="student.php" ><font size="2" color="hotpink"><b>Home</b></font></a></li>
      ...
      <ul class="nav navbar-nav navbar-right " style="background-color: green;">
         <li class="active" style="background-color:inverse"><a href="#"> <font size="2" color="hotpink"><b>Welcome <?php echo "$row[5]";?></b></font></a></li>
		...
		<div class="container"  >
			<div class="col-sm-12" >
              ...
              <div id="c" style="display:;">
                        ...
                        echo "<caption style='color:#D7DA0F '>$row[2]  $row[3]  $row[4] sem</capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Exam Id</th><th>Exam Type</th><th>Marks.</th><th>take examination</th></tr>";
                            while($row1=$result1->fetch_array())
                           {
                         
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><td>$row1[0]</td><td>$row1[2]</td><td>$row1[3]</td><td>
                            <form id='loginform' class='form-horizontal' role='form' action='take_exam.php' method='post'>
                              <input type='text' value='$row1[0]' style='display:none;' id='exam_id' name='exam_id'>
                              <input type='text' value='3' style='display:none;' id='t' name='t'>
                              <div class='form-group' >
                              <div class='col-md-4'>
                              <input type='text' value='' style='display:;' placeholder='enter password' id='pass' name='pass'>
