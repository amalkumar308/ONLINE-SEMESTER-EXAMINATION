...
if($_SERVER["REQUEST_METHOD"] == "POST") 
{
      ...
      {
      $sql = "SELECT * FROM student WHERE department = '$dipartment' AND branch='$branch' AND sem='$sem' GROUP BY pointer DESC";
		...
		<div class="container"  >
              ...
              <div class="col-sm-6 col-sm-offset-3" style="">
                  <div class="panel panel-info" style="border-radius: 70px;background-color:khaki;opacity:0.9;" >            
                      <div style="padding-top:20px" class="panel-body" align="center">
                                  <font color="hotpink" size="4"> <b>Select Branch and semester to see Students list</b></font>

                                    <form id="loginform" class="form-horizontal" role="form" action="faculty.php" method="post">
            ...
            <br><br><br>
              <div id="c" style="display:;">
                        ...
                        echo "<caption style='color:#D7DA0F '>$dipartment  $branch  $sem sem</capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Resistration No</th><th>Name</th><th>Mobile No.</th><th>Email</th><th>Pointer</th></tr>";
                            while($row1=$result1->fetch_array())
                           {
                         
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><td>$row1[0]</td><td>$row1[5]</td><td>$row1[6]</td><td>$row1[7]</td><td>$row1[8]</td></tr>";
                           }
