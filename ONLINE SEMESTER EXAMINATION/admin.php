              ...
              <div class="col-sm-6 col-sm-offset-3" style="">
                  <div class="panel panel-info" style="border-radius: 70px;background-color:khaki;opacity:0.9;" >            
                      <div style="padding-top:20px" class="panel-body" align="center">
                                  <font color="hotpink" size="4"> <b>Select department to See Faculty list</b></font>
            ...
            <br><br><br>
              <div id="c" style="display:;">
                        ...
                        echo "<caption style='color:#D7DA0F '>$dipartment</capiton>";
                          echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align='center'><th>Designation</th><th>Name</th><th>Mobile No.</th><th>Email</th><th>Subject</th></tr>";
                            while($row1=$result1->fetch_array())
                           {
                         
                            echo "<tr style=' border-left: 6px solid red; color:#D7DA0F ' align=''><form action='book.php' method='post'><td>$row1[7]</td><td>$row1[3]</td><td>$row1[4]</td><td>$row1[5]</td><td>$row1[6]</td></form></tr>";
                           }
